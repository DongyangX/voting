...
import { getProgram, getContestants, getPoll } from '@/services/blockchain'
...
export default function Polls({
  ...
  const runGetPoll = async () => {
    try {
      const progarm = getProgram(connection, wallet)
      const pollData = await getPoll(progarm, id as any)
      console.log(pollData)
      dispatch(setPoll(pollData))

      let contestantData = pollData.contestants
